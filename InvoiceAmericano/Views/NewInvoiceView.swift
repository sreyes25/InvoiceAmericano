...
// Draft types kept local to this screen for now.
// We can move them to Models later if you prefer.
struct InvoiceDraft {
    var number: String = ""
...
struct NewInvoiceView: View {
    ...
    private var canSave: Bool {
        guard draft.client != nil, !draft.number.trimmingCharacters(in: .whitespaces).isEmpty else { return false }
